...
export const TOOL_REGISTRY: ToolDefinition[] = [
  // Phase 1 - Fully Implemented MVP Tools
  {
    ...
    description: 'Calculate exact cubic yards, cubic meters, pre-mix bags, and over-order allowances with a live 3D parametric slab inspector.',
    tagline: 'Precision volumetric takeoff with real-time 3D dimensional verification.',
    iconName: 'Box',
    implemented: true,
    phase: 1,
